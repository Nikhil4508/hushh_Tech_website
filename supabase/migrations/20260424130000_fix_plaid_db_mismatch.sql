...
ALTER TABLE public.user_financial_data
  ...
  ADD COLUMN IF NOT EXISTS auth_numbers_encrypted JSONB,
...
COMMENT ON COLUMN public.user_financial_data.auth_numbers_encrypted IS 'Plaid Auth: account and routing numbers (encrypted)';
